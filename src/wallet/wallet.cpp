...
int CWalletTx::GetBlocksToMaturity() const
{
    ...
    //BPCTODO Some wallets are still not abandoning coinstakes correctly
...
void CWallet::StakeBPCs(bool fStake, CConnman* connman, CTxMemPool* mempool)
{
    ::StakeBPCs(fStake, this, connman, mempool, stakeThread);
}

void CWallet::StartStake(CConnman *connman, CTxMemPool* mempool)
{
    m_enabled_staking = true;
    StakeBPCs(true, connman, mempool);
}
