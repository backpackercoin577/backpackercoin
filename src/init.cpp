 ...
 */
static const char* BITCOIN_PID_FILENAME = "backpackercoind.pid";
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/backpackercoin577/backpackercoin>";

    return (strprintf(_("Copyright (C) %i The Backpackercoin Core Developers").translated, COPYRIGHT_YEAR) + " ") +
           "\n" +
