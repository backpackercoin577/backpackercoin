...
const char * const BITCOIN_CONF_FILENAME = "backpackercoin.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Backpackercoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Backpackercoin
    // Mac: ~/Library/Application Support/Backpackercoin
    // Unix: ~/.backpackercoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Backpackercoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Backpackercoin";
#else
    // Unix
    return pathRet / ".backpackercoin";
#endif
#endif
}
