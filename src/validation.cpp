...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if(nHeight <= 100) // first 100 Blocks
    {
       nSubsidy = 40000 * COIN; // 4000000.000000 
    }   
    else if(nHeight<=250000) // next 249900 Blocks
    {
        nSubsidy = 5 * COIN; // 1249500.000000
    }
    else if(nHeight<=1250000) // next 1000000 Blocks
    {
        nSubsidy = 3.75 * COIN; // 3750000.000000
    }
    else if(nHeight<=2250000) // next 1000000 Blocks
    {
        nSubsidy = 2.8125 * COIN; // 2812500.000000
    }
    else if(nHeight<=3250000) // next 1000000 Blocks
    {
        nSubsidy = 2.109375 * COIN; // 2109375.000000
    }
    else if(nHeight<=4250000) // next 1000000 Blocks
    {
        nSubsidy = 1.582031 * COIN; // 1582031.250000
    }
    else if(nHeight<=5250000) // next 1000000 Blocks
    {
        nSubsidy = 1.186523 * COIN; // 1186523.500000
    }
    else if(nHeight<=6250000) // next 1000000 Blocks
    {
        nSubsidy = 0.889893 * COIN; // 889892.562500
    }
    else if(nHeight<=7250000) // next 1000000 Blocks
    {
        nSubsidy = 0.667419 * COIN; // 667419.437500
    }
    else if(nHeight<=8250000) // next 1000000 Blocks
    {
        nSubsidy = 0.500565 * COIN; // 500564.562500
    }
    else if(nHeight<=9250000) // next 1000000 Blocks
    {
        nSubsidy = 0.375423 * COIN; // 375423.437500
    }
     else if(nHeight<=10250000) // next 1000000 Blocks
    {
        nSubsidy = 0.281568 * COIN; // 281567.562500
    }
     else if(nHeight<=11250000) // next 1000000 Blocks
    {
        nSubsidy = 0.211176 * COIN; // 211175.687500
    }
     else if(nHeight<=12250000) // next 1000000 Blocks
    {
        nSubsidy = 0.158382 * COIN; // 158381.765625
    }
    else if(nHeight<=13250000) // next 1000000 Blocks
    {
        nSubsidy = 0.118786 * COIN; // 118786.320312
    }
    else if(nHeight<=14250000) // next 1000000 Blocks
    {
        nSubsidy = 0.089090 * COIN; // 89089.734375
    }
    else if(nHeight<=14515938) // next 1000000 Blocks
    {
        nSubsidy = 0.066817 * COIN; // 17769.179346
    }
    else
    {
        nSubsidy = 0 * COIN;
